...
function scoreConfig(manifest: OwoggCreatorManifest): ScoreConfig | null {
...
function presentation(manifest: OwoggCreatorManifest): GamePresentation | undefined {
...
/** Builds server-owned canonical state from a validated Creator manifest. */
export function mapCreatorManifestToCanonical(input: {
