...
export function GridColumnSwitcher({
  ...
  return (
    <div className="flex items-center gap-2" data-testid="grid-column-switcher">
      <div className="flex h-11 items-center gap-1 rounded-2xl border border-border/80 bg-surface-raised p-1 lg:hidden">
        ...
        {MOBILE_COLUMN_OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              className={`h-9 min-w-8 cursor-pointer rounded-xl px-2 text-xs font-bold transition-all ${
                isSelected
      ...
      <div className="hidden h-11 items-center gap-1 rounded-2xl border border-border/80 bg-surface-raised p-1 lg:flex">
