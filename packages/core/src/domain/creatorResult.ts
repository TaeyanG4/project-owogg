...
export interface CreatorReportedResult {
...
export interface NormalizedCreatorResult {
...
export type CreatorResultNormalization =
  | { readonly valid: true; readonly result: NormalizedCreatorResult }
...
export function normalizeCreatorResult(
  manifest: OwoggCreatorManifest,
  input: CreatorReportedResult,
): CreatorResultNormalization {
