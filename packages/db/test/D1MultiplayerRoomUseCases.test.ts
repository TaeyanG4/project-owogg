...
function seedAuthority(raw: ReturnType<typeof createDatabase>["raw"]): void {
  ...
  raw
    ...
    .run(PROFILE_ID, GAME_ID, VERSION_ID, NOW, NOW);
}
...
test("two READY calls converge on one ACTIVE match and explicit leave aborts it", async () => {
