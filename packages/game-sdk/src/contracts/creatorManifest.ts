/** Public, engine-neutral OWOGG Creator Manifest v1 contract. */

export const OWOGG_CREATOR_MANIFEST_SCHEMA_URL =
  "https://owogg.com/schemas/manifest/v1.json" as const;
export const OWOGG_CREATOR_MANIFEST_VERSION = 1 as const;
export const OWOGG_CREATOR_MANIFEST_FILENAME = "owogg.json" as const;
...
export interface OwoggCreatorManifest {
  readonly $schema?: string | undefined;
  readonly schemaVersion: typeof OWOGG_CREATOR_MANIFEST_VERSION;
