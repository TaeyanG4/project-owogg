...
export const E2E_PUBLIC_GAMES: readonly PublicGame[] = [
  {
    ...
    catalog: { type: "GENRE_MODE", genre: "typing", mode: "single" },
    playModes: ["single"],
  ...
  },
  {
    ...
    catalog: { type: "GENRE_MODE", genre: "reaction", mode: "single" },
    playModes: ["single"],
    policy: { requiresAuth: false, leaderboard: false, score: null, xpPerCompletion: 0 },
    presentation: {
  ...
  },
  {
    ...
    catalog: { type: "GENRE_MODE", genre: "brain", mode: "single" },
    playModes: ["single"],
    policy: { requiresAuth: false, leaderboard: false, score: null, xpPerCompletion: 0 },
    presentation: {
  ...
  },
  {
    ...
    publisherName: "OWOGG",
    slug: "e2e-skill-card",
    title: "Platform E2E skill fixture",
    shortDescription: "Synthetic skill-test catalog fixture.",
    description: "Synthetic platform-only fixture for genre grouping tests.",
    publishedAt: "2026-01-04T00:00:00.000Z",
    stats: { playerCount: 6, bookmarkCount: 2, popularityScore: 12 },
    catalog: { type: "GENRE_MODE", genre: "skill", mode: "single" },
    playModes: ["single"],
    policy: { requiresAuth: false, leaderboard: false, score: null, xpPerCompletion: 0 },
    presentation: {
      viewport: { mode: "responsive" },
  ...
  },
  {
    ...
    publisherName: "OWOGG",
    slug: "e2e-multi-card",
    title: "Platform E2E multiplayer fixture",
    shortDescription: "Synthetic multiplayer catalog fixture.",
    description: "Synthetic platform-only fixture for dense card layout tests.",
    publishedAt: "2026-01-05T00:00:00.000Z",
    stats: { playerCount: 10, bookmarkCount: 4, popularityScore: 22 },
    catalog: { type: "GENRE_MODE", genre: "board", mode: "multi" },
